                        ...
                        <div key={student._id} className="card" style={{ display: 'flex', flexDirection: 'column' }}>
                            ...
                            <div style={{ display: 'flex', gap: '0.5rem', marginTop: 'auto', alignItems: 'center' }}>
                                ...
                                {(student.github || student.linkedin || student.portfolioWebsite) && (
                                    <div style={{ display: 'flex', gap: '0.7rem', padding: '0 0.5rem' }}>
                                        {student.portfolioWebsite && <a href={student.portfolioWebsite} target="_blank" rel="noreferrer" style={{ color: 'var(--color-primary)', textDecoration: 'none', fontSize: '1.2rem' }}>🌐</a>}
                                        {student.github && <a href={student.github} target="_blank" rel="noreferrer" style={{ color: 'var(--color-primary)', textDecoration: 'none', fontSize: '1.2rem' }}>🐙</a>}
                                        {student.linkedin && <a href={student.linkedin} target="_blank" rel="noreferrer" style={{ color: 'var(--color-primary)', textDecoration: 'none', fontSize: '1.2rem' }}>💼</a>}
                                    </div>
                                )}
                            </div>
                        </div>
